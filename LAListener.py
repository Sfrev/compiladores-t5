...
class LAListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by LAParser#cmdSenao.
    def enterCmdSenao(self, ctx:LAParser.CmdSenaoContext):
        pass

    # Exit a parse tree produced by LAParser#cmdSenao.
    def exitCmdSenao(self, ctx:LAParser.CmdSenaoContext):
        pass
    ...
    # Enter a parse tree produced by LAParser#parentesis_expressao.
    def enterParentesis_expressao(self, ctx:LAParser.Parentesis_expressaoContext):
        pass

    # Exit a parse tree produced by LAParser#parentesis_expressao.
    def exitParentesis_expressao(self, ctx:LAParser.Parentesis_expressaoContext):
        pass
