...
class LAVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by LAParser#declaracao_variavel.
    ...
    # Visit a parse tree produced by LAParser#cmdSenao.
    ...
    # Visit a parse tree produced by LAParser#parentesis_expressao.
    def visitParentesis_expressao(self, ctx:LAParser.Parentesis_expressaoContext):
        return self.visitChildren(ctx)
